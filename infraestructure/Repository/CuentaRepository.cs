...
namespace Infraestructure.Repository
{
    public class CuentaRepository
    {
        ...
        public string InsertarCuenta(CuentaModel cuenta)
        {
            try 
            {
                String query = "insert into cuenta(id_cuenta, nombre_cuenta, numero_cuenta, saldo, limite_saldo, limite_transferencia, estado) " +
                    " values(@id_cuenta, @nombre_cuenta, @numero_cuenta, @saldo, @limite_saldo, @limite_transferencia, @estado)";
                connection.Open();
